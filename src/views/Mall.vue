<template>
	<div class="Mall">
			...
			:before-close="handleClose">
				<el-form :inline="true" :rules='rules' :model="mallFrom" 			ref="mallForm">
					...
					<el-form-item label="入库时间"  prop="date">
						<el-col>
							<el-date-picker type="datetime" placeholder="选择时间" v-model="mallFrom.date" style="width: 100%;"  value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
						</el-col>
					</el-form-item>
					<el-form-item>
		...
		<div class="context-mall">
				<el-table style="width: 100%" :data="mallList">
