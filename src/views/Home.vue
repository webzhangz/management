	...
	<div>
		...
		<el-row>
			<el-col :span="8">
				...
				<el-card class="lab-card" style="height: 346px;">
			...
			<el-col :span="16">
				...
				<el-card style="height: 250px;margin-left: 20px;">
					<!-- 折线图 -->
					<div ref="lineEcharts" style="height: 230px;z-index: 9999;"></div>
				</el-card>
				<div class="right-charts">
					<el-card style="height: 200px">
						<!-- 柱状图 -->
						<div ref="barEcharts" style="height: 180px;z-index: 9999;"></div>
					</el-card>
					<el-card style="height: 200px">
						<div ref="pieEcharts" style="height: 180px;z-index: 9999;"></div>
						<!-- 饼图 -->
					</el-card>
				</div>
			</el-col>
